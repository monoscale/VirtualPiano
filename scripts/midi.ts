...
class VirtualPiano {
    ...
    private noteOn(note: number, force: number): void {
        this.visualPiano.children[note].innerHTML = this.NOTES[parseInt(this.visualPiano.children[note].id) % 12] + ((parseInt(this.visualPiano.children[note].id) - (parseInt(this.visualPiano.children[note].id) % 12)) / 12);
    ...
    private noteOff(note: number, force: number): void {
        this.visualPiano.children[note].innerHTML = '';
